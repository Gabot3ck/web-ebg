		...
		<section className="wrapper_queHacemos w-100 mx-auto d-flex justify-content-center ">
			...
			<main className="main_queHacemos ps-5 ps-xxl-0">
				<section className="main_queHacemos_texto">
					...
					<p className="text-start">En <strong>EBG Chile</strong>, como expertos en <strong>Ingeniería y Construcción</strong> nos dedicamos profesionalmente a transformar tus ideas en realidades tangibles, ofrecemos una amplia gama de servicios para cubrir todas tus necesidades en el campo de la edificación.</p><br />
