    ...
    return (<>
        <footer className="w-100 py-3">
            <div className="footer_pie mx-auto d-flex flex-column justify-content-center align-items-center">
                ...
                <p className="autor step-1">Elaborado con pasión por <a href="https://www.linkedin.com/in/gabriel-castillo-frontend/" target="_blank" rel="noopener noreferrer">Gabriel Castillo</a></p>
            </div>
        </footer>
