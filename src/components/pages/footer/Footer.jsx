        ...
        <footer className="w-100 py-3">
            <div className="footer_pie mx-auto d-flex flex-column justify-content-center align-items-center">
                ...
                <p className="autor step-1">
                    Desarrollado por <a href="https://www.linkedin.com/in/gabriel-castillo-frontend/" target="_blank" rel="noopener noreferrer" aria-label="Enlace al autor de la página web">Gabriel Castillo</a>
                </p>
            </div>
        </footer>
